...
**For Development: Local Redis (Recommended)**
```powershell
...
**For Production: AWS ElastiCache or Upstash**
- **ElastiCache**: Managed Redis cluster in AWS VPC
- **Upstash**: Serverless, pay-per-request (~$0.20 per 100K commands)
